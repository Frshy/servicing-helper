...
export default function DashboardNavElements() {
    ...
    return (
        <div className="flex flex-col items-center w-[230px]">
            <Link to="/dashboard" className={`text-white px-4 py-3 text-md cursor-pointer ${isEndpointOpened('/dashboard') ? 'bg-blue-600' : ''} hover:bg-blue-600 duration-300 rounded-md text-left my-1 w-full flex`}>
            ...
            {user.value?.admin && (
                <Link to="/admin" className="text-white px-4 py-3 text-md cursor-pointer hover:bg-blue-600 duration-300 rounded-md text-left my-1 w-full flex">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
